...
public final class DaggerChatApplication_HiltComponents_SingletonC {
  ...
  private static final class SingletonCImpl extends ChatApplication_HiltComponents.SingletonC {
    ...
    private void initialize(final ApplicationContextModule applicationContextModuleParam) {
      this.provideNominatimClientProvider = DoubleCheck.provider(new SwitchingProvider<OkHttpClient>(singletonCImpl, 1));
      this.nominatimServiceProvider = DoubleCheck.provider(new SwitchingProvider<NominatimService>(singletonCImpl, 0));
      ...
      this.provideInvalidationInterceptorProvider = DoubleCheck.provider(new SwitchingProvider<Interceptor>(singletonCImpl, 7));
    ...
    private static final class SwitchingProvider<T> implements Provider<T> {
      ...
      public T get() {
        switch (id) {
          case 0: // org.mochios.android.places.NominatimService 
          return (T) new NominatimService(singletonCImpl.provideNominatimClientProvider.get());

          case 1: // @org.mochios.android.places.NominatimClient okhttp3.OkHttpClient 
          return (T) NominatimModule_ProvideNominatimClientFactory.provideNominatimClient();

          case 2: // org.mochios.android.auth.SessionManager 
          ...
          case 3: // org.mochios.android.i18n.PreferencesManager 
          ...
          case 6: // @org.mochios.android.api.AuthInterceptor okhttp3.Interceptor 
          return (T) ApiClient_ProvideAuthInterceptorFactory.provideAuthInterceptor(singletonCImpl.sessionManagerProvider.get());

          case 7: // @org.mochios.android.api.InvalidationInterceptor okhttp3.Interceptor 
